...
namespace Agriculture.Business.Concrete
{
    public class UserService : IUserService
    {
        ...
        public UserService(IUserRepository userRepository, IMailVerifyRepository mailVerifyRepository, IPasswordResetRepository passwordResetRepository)
        {
        ...
        public UserLoginResponse Login(UserLoginRequest request)
        {
            ...
            try
            {
                ...
                {
                    return GetLoginResponse("400", "Mailinizi onaylamanız gerekmektedir. Lütfen Maillerinizi kontrol ediniz.");
                }
        ...
        //SendVerifyEmail sendVerify = new SendVerifyEmail();


        public void SendVerifyEmail(string mail, string guid)
        {
            string verifyUrl = "http://agriculture.sagtek.com.tr/api/auth/Verify/" + guid + " \n " +
                                "Bu Maili Yanlışlıkla Aldığınızı Düşünüyorsanız veya Size Ait Bir Talep Değilse Lütfen Dikkate Almayın. \n İnsense Biyomedikal Yazılım \n www.insense.com.tr   ";

            MailMessage msg = new MailMessage();
            SmtpClient client = new SmtpClient();
            client.Credentials = new System.Net.NetworkCredential("insense.yazilim@gmail.com", "FJjqA82ntYzOh1cD");
            client.Port = 587;
            client.Host = "smtp-relay.sendinblue.com";
            client.EnableSsl = false;
            msg.To.Add(mail);
            msg.From = new MailAddress("insense.yazilim@gmail.com", "Agriculture Mail Doğrulaması");
        ...
        public void ChangedPasswordEmail(string mail)
        {
            ...
            if (mail.EndsWith("@outlook.com") || mail.EndsWith("@hotmail.com") || mail.EndsWith("@outlook.com.tr"))
            {
                ...
                msg.To.Add(mail);
                msg.From = new MailAddress("insense.yazilim@gmail.com", "Smartsense Şifre Değiştirilme İşlemi");
            ...
            else
            {
                ...
                client.EnableSsl = true;
                msg.To.Add(mail);
                msg.From = new MailAddress("insense.yazilim@gmail.com", "Agriculture Şifre Değiştirilme İşlemi");
                msg.Subject = "Şifre Değiştirilme İşlemi";
                msg.IsBodyHtml = true;
                msg.Body = myString;
        ...
        {
            string verifyUrl = "http://agriculture.sagtek.com.tr/ResetPassword/" + guid;
            ...
            if (mail.EndsWith("@outlook.com") || mail.EndsWith("@hotmail.com") || mail.EndsWith("@outlook.com.tr"))
            {
                ...
                client.EnableSsl = true;
                msg.To.Add(mail);
                msg.From = new MailAddress("insense.yazilim@gmail.com", "Agriculture Şifre Sıfırlama");
